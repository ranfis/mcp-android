 ...
 ************/
public class MateriasActualesCustomAdapter extends BaseAdapter {
    ...
    public MateriasActualesCustomAdapter(Activity a, List<Asignatura> d, Resources resLocal) {
        activity = a;
        data = d;
        res = resLocal;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.materiasactuales_child, null);

            /****** View Holder Object to contain tabitem.xml file elements ******/

            holder = new ViewHolder();
            holder.nombre = (TextView) vi.findViewById(R.id.materiasactuales_subject_name);
            holder.codigo = (TextView) vi.findViewById(R.id.materiasactuales_codigo);
            holder.critica = (TextView) vi.findViewById(R.id.materiasactuales_critica);
            holder.creditos = (TextView) vi.findViewById(R.id.materiasactuales_creditos);
            holder.prerrequisitos = (TextView) vi.findViewById(R.id.materiasactuales_prerrequisitos);
            holder.estado = (TextView) vi.findViewById(R.id.materiasactuales_estado);
